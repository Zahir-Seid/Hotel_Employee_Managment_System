...
export function RoleNewView() {
  ...
  const { create, loading, error: apiError } = useCreateRole();
  ...
  const handleBlur = (name: keyof FieldErrors) => {
    ...
    const err = validateField(name, form[name as keyof typeof form] || '');
  ...
  return (
    <div className="max-w-2xl">
      ...
      <h1 className="page-title mb-6">New Role</h1>
        ...
        <div className="bg-surface border border-hairline rounded-lg p-6 space-y-5">
          ...
          <div>
            ...
            <input
              ...
              className={`w-full px-3 py-2 text-sm bg-canvas border rounded-md outline-none transition-colors data-mono ${
